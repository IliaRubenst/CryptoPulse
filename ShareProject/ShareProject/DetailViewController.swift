...
//    private var data = [
//        CandlestickData(time: .string("2019-05-24"), open: 57.34, high: 57.57, low: 56.73, close: 57.08),
//        CandlestickData(time: .string("2019-05-25"), open: 56.82, high: 56.90, low: 55.75, close: 55.85),
//        CandlestickData(time: .string("2019-05-26"), open: 56.06, high: 56.81, low: 55.83, close: 56.58),
//        CandlestickData(time: .string("2019-05-29"), open: 56.75, high: 57.17, low: 56.71, close: 56.84),
//        CandlestickData(time: .string("2019-05-30"), open: 56.99, high: 57.45, low: 56.76, close: 57.19),
//        CandlestickData(time: .string("2019-05-31"), open: 57.00, high: 57.30, low: 56.52, close: 56.52),
...
//        CandlestickData(time: .string("2019-05-04"), open: 56.83, high: 57.09, low: 56.74, close: 56.91),
//        CandlestickData(time: .string("2019-05-05"), open: 56.69, high: 56.81, low: 56.33, close: 56.63),
//        CandlestickData(time: .string("2019-05-06"), open: 56.66, high: 56.70, low: 56.25, close: 56.38),
//        CandlestickData(time: .string("2019-05-07"), open: 56.12, high: 56.56, low: 55.93, close: 56.48),
//        CandlestickData(time: .string("2019-05-08"), open: 56.49, high: 57.04, low: 56.26, close: 56.91),
//        CandlestickData(time: .string("2019-05-09"), open: 56.72, high: 57.34, low: 56.66, close: 56.75),
//        CandlestickData(time: .string("2019-05-10"), open: 56.76, high: 57.19, low: 56.50, close: 56.55),
//        CandlestickData(time: .string("2019-05-11"), open: 56.51, high: 56.84, low: 56.17, close: 56.81),
//        CandlestickData(time: .string("2019-05-12"), open: 57.00, high: 57.80, low: 56.82, close: 57.38),
//        CandlestickData(time: .string("2019-05-13"), open: 57.06, high: 58.48, low: 57.01, close: 58.09),
//        CandlestickData(time: .string("2019-05-14"), open: 59.15, high: 60.54, low: 58.00, close: 59.01),
//        CandlestickData(time: .string("2019-05-15"), open: 59.10, high: 59.63, low: 58.76, close: 59.50),
//        CandlestickData(time: .string("2019-05-16"), open: 59.09, high: 59.37, low: 58.96, close: 59.25),
//        CandlestickData(time: .string("2019-05-17"), open: 59.00, high: 59.27, low: 58.54, close: 58.87),
//        CandlestickData(time: .string("2019-05-18"), open: 59.07, high: 59.36, low: 58.67, close: 59.32),
//        CandlestickData(time: .string("2019-05-19"), open: 59.21, high: 59.66, low: 59.02, close: 59.57)
//    ]
    ...
    override func viewDidLoad() {
        ...
        //        chartManager.startManager()
        //        chartManager.setupChart()
        //        chartManager.setupData()
        //
        setupChart()
//        setupData()
        setupSeries()
